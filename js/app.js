(() => {
  ...
  new pe("max").init();
  const ue = document.querySelectorAll(".menu__list");
  function he() {
  ...
  ue &&
    ue.forEach((e) => {
      e.addEventListener("click", function (e) {
        e.target.closest(".menu__link") && he();
      });
    });
  const fe = document.querySelector(".header__mobile-search");
  fe &&
